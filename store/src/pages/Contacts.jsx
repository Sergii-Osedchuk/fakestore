      ...
      <div className={styles.contactWraper}>
        ...
        <ul className={styles.contacts}>
          <li className={styles.phone}>
            <a href='tel:380988889900'>38098-888-99-00</a>
          </li>
          <li className={styles.phone}>
            <a href='tel:380938889900'>38093-888-99-00</a>
          </li>
          <li className={styles.phone}>
            <a href='tel:380928889900'>38092-888-99-00</a>
          </li>
          <ul className={styles.logos}>
            ...
            <li className={styles.link}>
              <a href='https://t.me/sergiosad' target='_blank' rel='noreferrer' className={styles.link}>
